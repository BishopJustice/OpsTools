o#Copy a list of numbers and this script with turn it into a lyft list style list and optionally add sql fields
import pyperclip
import re
...
sql = input('Numbers copied to clipboard. Would you like to ready it for SQL? (Y/N)')
